...
data.in <- data %>%
  dplyr::rename(ntv_invisibility_1 = NtvInvisibility_1,
                ...
                ntv_invisibility_4 = NtvInvisibility_4,
                ntv_invisibility_5 = NtvInvisibility_5,
                ntv_invisibility_6 = NtvInvisibility_6,
                ntv_invisibility_7 = Invisibility1_13,
...
in.raw <- data.in %>%
  dplyr::select(
    ntv_invisibility_1:ntv_invisibility_3, ntv_invisibility_5:ntv_invisibility_12)
...
inv.lm <- lm(StructuralForces ~ Invisibility)
summary(inv.lm)

corr.test(StructuralForces, Invisibility)
```
...
view(structuralforces.r)

install.packages("pastecs")
library(pastecs)
stat.desc(structuralforces.r)
